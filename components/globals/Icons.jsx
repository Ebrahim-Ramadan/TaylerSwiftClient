...
export const Spotify = ({ props }) => {
   ...
   return (
       <svg
           ...
           <g fill="#b2847a" fill-rule="nonzero" stroke="none" strokeWidth="1" strokeLinecap="butt" strokeLinejoin="miter" strokeMiterlimit="10" strokeDasharray="" strokeDashoffset="0" fontFamily="none" font-weight="none" font-size="none" text-anchor="none"
